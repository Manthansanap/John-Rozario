      ...
      <section className="py-24 bg-gold-gradient relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Link href="/booking" className="bg-rich-black text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-zinc-900 transition-colors gold-glow">Book Your Appointment</Link>
            <Link href="/contact" className="border-2 border-rich-black text-rich-black px-10 py-5 rounded-full font-bold text-lg hover:bg-rich-black hover:text-white transition-all">Contact Us Now</Link>
          </div>
        </div>
